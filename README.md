...
| Source text | Model outputs | Correct output | CER |
| :-------------: | :-------------: | :-------------: | :------: |
| afanasyeva  | **афанасьева**<br/>афанасиева<br/>афанасева  | `афанасьева` |  0<br/>1<br/>1<br/>... | 
| bobylev  | бобылев<br/>**бобылёв**<br/>бодылёв  | `бобылёв` |  1<br/>0<br/>1<br/>... | 
| savostyanov  | савостянов<br/>савостианов<br/>**савостьянов**  | `савостьянов` |  1<br/>2<br/>0<br/>... | 
| suzdal  | суздал<br/>сюздаль<br/>сюздал  | `суздаль` |  0<br/>1<br/>1<br/>... | 
| fargère  | фарджер<br/>фаргер<br/>фарджир  | `фаржер` |  0<br/>1<br/>1<br/>... | 
| neftegorsk  | нефтегоргк<br/>нефтегорг<br/>нефтегорк  | `нефтегорск` |  1<br/>2<br/>1<br/>... | 
